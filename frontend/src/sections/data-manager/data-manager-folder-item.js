...
import DataManagerFileDetails from './data-manager-file-details';
import DataManagerNewFolderDialog from './data-manager-new-folder-dialog';

// ----------------------------------------------------------------------

export default function DataManagerFolderItem({
  folder,
  selected,
  onSelect,
  onDelete,
...
DataManagerFolderItem.propTypes = {

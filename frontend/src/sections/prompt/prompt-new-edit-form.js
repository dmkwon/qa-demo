...
//
import PromptDetailsPreview from './prompt-details-preview';

// ----------------------------------------------------------------------

export default function PromptNewEditForm({ currentPost }) {

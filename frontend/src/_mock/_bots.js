...
export const BOT_DETAILS_TABS = [
  { value: 'content', label: 'Bot Content' },
...
export const BOT_WORKING_SCHEDULE_OPTIONS = [
  'Monday to Friday',
  'Weekend availability',
  'Day shift',
];

export const BOT_EMPLOYMENT_TYPE_OPTIONS = [
...
export const BOT_EXPERIENCE_OPTIONS = [
...
export const BOT_BENEFIT_OPTIONS = [
...
export const BOT_PUBLISH_OPTIONS = [
  {
    value: 'published',
    label: 'Published',
  },
...
export const _bots = [...Array(12)].map((_, index) => {
  ...
  const benefits = BOT_BENEFIT_OPTIONS.slice(0, 3).map((option) => option.label);

  const experience =
    BOT_EXPERIENCE_OPTIONS.map((option) => option.label)[index] || BOT_EXPERIENCE_OPTIONS[1].label;
  ...
  return {
    ...
    role: _mock.role(index),
    title: _mock.botTitle(index),
    createdAt: _mock.time(index),
    expiredDate: _mock.time(index),
    skills: BOT_SKILL_OPTIONS.slice(0, 3),
    totalViews: _mock.number.nativeL(index),
    workingSchedule: BOT_WORKING_SCHEDULE_OPTIONS.slice(0, 2),
  };
});
